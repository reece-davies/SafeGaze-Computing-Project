          ...
          <table class="table table-striped table-sm">
            ...
            <tbody>
              ...
              */
              ...
              // Loop through database for members that have the same access code AND have status inactive
              require './php/dbh.inc.php';

              //$sql = "SELECT * FROM members where facility_id=" . $_SESSION['facilityId'] . " and status='active'";
              $sql = "SELECT * FROM members where facility_id=? and status='inactive'";
              ...
              else
              {
                ...
                while ($row = mysqli_fetch_assoc($result))
                {
                  ...
                  <tr>
                    ...
                    <td>'. $memberGender .'</td>
                    <td>'. $memberDOB .'</td>
                    <td><button onclick="manageUser('. $memberId . ')" class="btn btn-sm btn-actions btn-warning">Manage</button></td>
                  </tr>
                  ';
                }
          ...
          <table class="table table-striped table-sm">
            ...
            <tbody>
              ...
              */
              ...
              // Loop through database for members that have the same access code AND have status declined
              require './php/dbh.inc.php';

              //$sql = "SELECT * FROM members where facility_id=" . $_SESSION['facilityId'] . " and status='active'";
              $sql = "SELECT * FROM members where facility_id=? and status='declined'";
              $stmt = mysqli_stmt_init($conn);
              ...
              else
              {
                ...
                while ($row = mysqli_fetch_assoc($result))
                {
                  ...
                  <tr>
                    ...
                    <td>'. $memberGender .'</td>
                    <td>'. $memberDOB .'</td>
                    <td><button onclick="manageUser('. $memberId . ')" class="btn btn-sm btn-actions btn-danger">Manage</button></td>
                  </tr>
                  ';
                }
