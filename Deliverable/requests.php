          ...
          <table class="table table-striped table-sm">
            ...
            <tbody>
              ...
              */
              ...
              // Loop through database for members that have the same access code AND have status pending
              require './php/dbh.inc.php';

              //$sql = "SELECT * FROM members where facility_id=" . $_SESSION['facilityId'] . " and status='active'";
              $sql = "SELECT * FROM members where facility_id=? and status='pending'";
                  ...
                  <tr>
                    ...
                    <td>
                      <form action="php/change-member-status.inc.php" method="post">
                        ...
                        <button class="btn btn-sm btn-actions btn-success" type="submit" name="accept-member-submit">Accept</button>
                        <button class="btn btn-sm btn-actions btn-danger" type="submit" name="decline-member-submit">Decline</button>
                      </form>
                    </td>
                  </tr>
                  ';
