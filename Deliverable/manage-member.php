        ...
        else
        {
            ...
            <form style="padding-bottom: 1rem;" action="php/change-member-status.inc.php" method="post">
              ...
              <div class="form-check">
                ...
                <input class="form-check-input" type="checkbox" name="defaultCheckMon" value="mon_times" id="defaultCheckMon">
              ...
              <div class="form-check">
                ...
                <input class="form-check-input" type="checkbox" name="defaultCheckTue" value="tue_times" id="defaultCheckTue">
              ...
              <button style="margin-top: 1rem;" class="btn btn-lg btn-cyan btn-block" type="submit" name="change-member-times-submit">Change access times</button>
            </form>';
