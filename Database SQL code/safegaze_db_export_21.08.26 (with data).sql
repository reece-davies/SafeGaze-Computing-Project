...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 26, 2021 at 06:12 PM
...
INSERT INTO `sun_times` (`access_id`, `member_id`, `start_time`, `end_time`) VALUES
(3, 9, '13:00:00', '13:13:00');
...
--
ALTER TABLE `livestreams`
  MODIFY `livestream_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `mon_times`
  MODIFY `access_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `sun_times`
  MODIFY `access_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `wed_times`
  MODIFY `access_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
