...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 17, 2021 at 03:23 PM
...
(7, 'Final Test', 'finaltest', '$2y$10$gLf/OwHqKts0SGBJQd8fbe1EVeZzXJ//xL6ATAy8kc.VRPdEvAlmC', 'finaltest@test.com', '01752', 'Final Test Street', 'AB12CD', 'finaltestaccess'),
(8, 'Error Test', 'errortest', '$2y$10$B1wSuZ455X6M0Uhoc0gXHeC1G7k5MDR1Sx3YTGq0eoOx0FO1yeHpC', 'errortest@test.com', '01752', 'Error test street', 'ET11TE', 'errortest');
...
(7, 6, 'fourthUser', 'password', 'fourthuser@test.com', 'Fourth', 'User', NULL, 'female', 'pending'),
(7, 7, 'fifthUser', '$2y$10$.FgsgffBVC/5rKHxrtWp1OswlKoHZXdCFvotE6RzrQF7fc.exYtaG', 'fifthuser@test.com', 'Fifth', 'User', '2020-01-01', 'male', 'active'),
(7, 8, 'sixthUser', 'password', 'sixthuser@test.com', 'Sixth', 'User', '2020-12-24', 'female', 'inactive'),
(7, 9, 'seventhUser', '$2y$10$.FgsgffBVC/5rKHxrtWp1OswlKoHZXdCFvotE6RzrQF7fc.exYtaG', 'seventhuser@test.com', 'Seventh', 'User', '2020-12-23', 'male', 'pending');
